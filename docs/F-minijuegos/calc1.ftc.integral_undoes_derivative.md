...
- `gen_lossy_pair`: `operations` (el par de operaciones, con una que destruye información); `returns` en {un cofre, una familia, dos ramas}, la etiqueta de qué devuelve la llave; `seed`. Solo en el nivel 8 y en `generalize`.
